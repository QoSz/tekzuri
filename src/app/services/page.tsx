      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          {services.map((service, index) => (
            ...
            <Link
              href={service.href}
              className="group cursor-pointer relative bg-bg-elevated border border-border-card rounded-2xl p-8 lg:p-10 hover:bg-bg-elevated-2 hover:border-border-strong transition-all duration-300 focus-ring block"
              style={{
